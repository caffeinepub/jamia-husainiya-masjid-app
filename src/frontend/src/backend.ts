...
export class Backend implements backendInterface {
    ...
    async getAnnouncementsByDate(): Promise<Array<Announcement>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAnnouncementsByDate();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateAdminCredentials(arg0: string, arg1: string, arg2: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateAnnouncement(arg0: AnnouncementId, arg1: string, arg2: string, arg3: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updatePrayerTimes(arg0: PrayerTimes): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updatePrayerTimes(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
